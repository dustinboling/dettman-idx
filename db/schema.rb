...
ActiveRecord::Schema.define(version: 20140728080243) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "residential_properties", force: true do |t|
  ...
  add_index "residential_properties", ["ml_number"], name: "index_residential_properties_on_ml_number", using: :btree

  create_table "residential_searches", force: true do |t|
    t.string   "accumail_result"
    t.decimal  "acres",                                           precision: 12, scale: 4
    t.integer  "age"
    t.text     "agent_only_remarks"
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.decimal  "max_listing_price",                               precision: 12, scale: 2
    t.decimal  "min_listing_price",                               precision: 12, scale: 2
  end

  create_table "rets_imports", force: true do |t|
